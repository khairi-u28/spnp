...
<head>
    ...
    <title>Admin SPNP | Kelola Info Pemutihan</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Kelola Info Pemutihan</h1>
                    <div class="col-md-12 mb-3">
                        <a href="{{ url('pemutihan/create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data Info Pemutihan</a>
                    </div>
                                ...
                                <table class="table table-striped table-sm" id="dataTable" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$pemutihan->judul_pemutihan}}</td>
                                            <td class="setWidth concat">
                                                <div>
                                                    {{$pemutihan->konten_pemutihan}}
                                                </div>
                                            </td>
                                            <td>
                                                <!-- <a href="{{ asset('images_pemutihan/'. $pemutihan->foto_pemutihan) }}" target="_blank" rel="noopener noreferrer">Lihat Gambar</a> -->
                                                <a href="{{ url('images_pemutihan')}}/{{$pemutihan->foto_pemutihan}}" target="_blank" rel="noopener noreferrer">Lihat Gambar</a>
                                            </td>
                                            <td>{{$pemutihan->created_at}}</td>
                                            <td>
                                                <form method="POST" action="{{ url('pemutihan')}}/{{$pemutihan->id_infoPemutihan}}">
                                                    <a href="{{ url('pemutihan')}}/{{$pemutihan->id_infoPemutihan}}/edit" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE') }}
